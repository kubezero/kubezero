# KubeZero Worker EKS Package

This package provisions an AWS EKS worker cluster using Crossplane, following KubeZero's modular, GitOps-native structure.
...
## Usage
- Copy or symlink this package to the `registry/worker` directory to enable it.
